...
Read what autogenerate produced before applying it. It compares `Base.metadata` against the live
database and is good at additions, unreliable about renames — a renamed column is detected as a
